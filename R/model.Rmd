...
nla.all <-  filter(nla.cc, tmean_2m < 70) %>%
  dplyr::select(tmean_2m, year,date, longitude, latitude, tmean,          tmean_avg30,percent_impervious,surface_area,shoreline_length, shoreline_dev, max_length, max_width, mean_width, max_depth, max_depth, volume, elevation)
