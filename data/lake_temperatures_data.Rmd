...
```{r get_prism, include=FALSE, echo=FALSE, eval= FALSE}
...
```{r get_morpho, include=FALSE, echo=FALSE, eval=FALSE} 
...
```{r centroids, include=FALSE, echo=FALSE, eval=FALSE} 
...
```{r cellnums, include=FALSE, echo=FALSE, eval=FALSE} 
# get a prism raster 
...
```{r func_prism, include=FALSE, echo=FALSE, eval=TRUE}
...
```{r vals_prism, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r means_prism, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r elevatr, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r lakes, include=FALSE, echo=FALSE, eval=FALSE}
...
```{r get_nla_gis, include=FALSE, echo=FALSE, eval=FALSE} 
...
```{r nla_data, include=FALSE, echo=FALSE, eval=FALSE} 
...
```{r imperv, include=FALSE, echo=FALSE, eval=FALSE} 
...
```{r tbl_nla, include=FALSE, echo=FALSE, eval=FALSE} 
...
```{r tm_raw, include=FALSE, echo=FALSE, eval=FALSE} 
...
```{r tm, include=FALSE, echo=FALSE, eval=FALSE} 
...
```{r chk_imp, include=FALSE, echo=FALSE, eval=FALSE} 
# get the nlcd crs
...
```{r chk_nla, include=FALSE, echo=FALSE, eval=FALSE} 
######### elevation
...
```{r doc_db, include=FALSE, echo=FALSE, eval=TRUE, cache=TRUE} 
...
# lakes
  ...
  l_n <- dbGetQuery(means, 'SELECT Count(*) FROM lakes') # 363300 observations
...
# tmeans
  ...
  tm_n <- dbGetQuery(means, 'SELECT Count(*) FROM tmeans') # 651830628 (651.8 m) observations
...
# tmeans_raw
  ...
  tmr_n <- dbGetQuery(means, 'SELECT Count(*) FROM tmeans_raw') # 5342874 (5.3 m) observations
...
* The database ('data_local/lake_temperatures.sqlite') is too large (`r size`) to keep on github.  It will have to be compiled by running the code chunks in this document.  It could be a lengthy and difficult task.

* The database includes the `r length(tables)` tables: `r tables` 
...
```{r bdata, include=FALSE, echo=FALSE, cache=TRUE}
